     ...
     }else if($_GET['prov']=="Limpopo")
     {
      ...
      <h4>Please Select your District</h4>
       ...
       <form class="" action="circut.php" method="GET">
         <select class="" style="width: 280px; height: 30px;" name="district">
        ...
        <?php
        $parentIDobj  = new ParentsID();
        $parentID =  $parentIDobj ->GetParentsID($_GET['ParentPhone']);
         ?>
         <input type="hidden" name="ParentID" value="<?php echo $parentID['parentID'] ; ?>">
