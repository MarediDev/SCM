...
<body>
    ...
    <div class="login-container">
        <h2>Select Grades Which you teach</h2>
        <form class="" action="../Objects/TeacherGradeObj.php" method="GET">

            <div class="dropdown">
              <!-- Dropdown button -->
              <button class="dropbtn">Select Grades </button>
              <!-- Dropdown content -->
              <div class="dropdown-content">
                <!-- Checkboxes within the dropdown content -->
                <label>Grade 8 <input type="checkbox" name="grade8" value="Grade 8">   </label>
                <label>Grade 9  <input type="checkbox" name="grade9" value="Grade 9"> </label>

                <label>Grade 10<input type="checkbox" name="grade10" value="Grade 10"><label>
                <label>Grade 11<input type="checkbox" name="grade11" value="Grade 11"><label>
                <label>Grade 12<input type="checkbox" name="grade12" value="Grade 12"><label>
                  <br><br>
